...
/**
 * Servlet implementation class ProductNewelistController
 */
@WebServlet("/elistNew.pr")
public class ProductNewelistController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductNewelistController() {
        super();
