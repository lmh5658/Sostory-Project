...
/**
 * Servlet implementation class ProductNewjlistController
 */
@WebServlet("/jlistNew.pr")
public class ProductNewjlistController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductNewjlistController() {
        super();
