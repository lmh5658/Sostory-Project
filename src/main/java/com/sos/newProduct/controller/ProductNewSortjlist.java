...
/**
 * Servlet implementation class ProductNewSortjlist
 */
@WebServlet("/sjjlistNew.pr")
public class ProductNewSortjlist extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductNewSortjlist() {
        super();
