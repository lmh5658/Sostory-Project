...
/**
 * Servlet implementation class ProductNewSortelist
 */
@WebServlet("/seelistNew.pr")
public class ProductNewSortelist extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductNewSortelist() {
        super();
