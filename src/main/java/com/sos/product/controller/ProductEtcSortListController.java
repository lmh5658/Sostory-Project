...
/**
 * Servlet implementation class ProductEtcSortListController
 */
@WebServlet("/seelist.pr")
public class ProductEtcSortListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductEtcSortListController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Product> list = new ProductService().sortEtcList(select, pi);
