...
/**
 * Servlet implementation class ProductDressingSortListController
 */
@WebServlet("/sddlist.pr")
public class ProductDressingSortListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductDressingSortListController() {
        super();
