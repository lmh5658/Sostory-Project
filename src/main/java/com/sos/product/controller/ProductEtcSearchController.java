...
/**
 * Servlet implementation class ProductEtcSearchController
 */
@WebServlet("/selist.pr")
public class ProductEtcSearchController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductEtcSearchController() {
        super();
