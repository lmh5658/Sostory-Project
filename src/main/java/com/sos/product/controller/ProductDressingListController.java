...
/**
 * Servlet implementation class ProductDraListController
 */
@WebServlet("/dlist.pr")
public class ProductDressingListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProductDressingListController() {
        super();
