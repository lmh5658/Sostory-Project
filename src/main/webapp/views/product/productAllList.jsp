                    ...
                    <div class="product-category my-5 w-100 d-flex justify-content-evenly">
                        ...
                        <!-- 검색 영역-->
						  ...
						  <!-- Button to Open the Modal -->
						   <a  style="z-index: 1"; href="#" style="color: black;" data-toggle="modal" data-target="#myModal"><svg xmlns="http://www.w3.org/2000/svg"  height="30" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
