                ...
                <table>
                          ...
                          <select class="product_name" name="productNo" onchange="updateHiddenCategoryNo()" required>
							    <% if (list != null) { %>
							        <% for (OrderProduct o : list) { %>
							            ...
							            <option selected value="<%= o.getProductNo() %>" data-category-no="<%= o.getCategoryNo() %>"><%= o.getProductName() %></option>
							            <% } else { %>
                    ...
                    <tr>
                        ...
                        <select class="recipe_info" name="difficulty" style="width: 80px;">
                            ...
                            <option value="상" <%if(recipe.getDifficulty().equals("상")){ %>selected<%}%>>상</option>
                            <option value="중" <%if(recipe.getDifficulty().equals("중")){ %>selected<%}%>>중</option>
                            <option value="하" <%if(recipe.getDifficulty().equals("하")){ %>selected<%}%>>하</option>
                        </select>
                        </td>
                    </tr>
					<% int i = 1; %>
                    ...
                    <tr>
                        ...
                        <td id="ingredientForm">
                            <input class="ingredient" type="text" style="width: 120px; margin-right: 20px;" name="ingredientName" placeholder="재료명" value="<%=recipe.getIngredientName() %>" required>
                            <input class="ingredient" type="number" min="1" style="width: 120px;" name="amount" placeholder="수량" value="<%=recipe.getIngredientAmount() %>" required>
                            <select class="ingredient" name="unit" style="width: 70px;" required>
                                <option value="g" <%if(ing.getIngredientName().equals("g")){ %>selected<%}%>>g</option>
                                <option value="kg" <%if(recipe.getIngredientUnit().equals("kg")){ %>selected<%}%>>kg</option>
                                <option value="ml" <%if(recipe.getIngredientUnit().equals("ml")){ %>selected<%}%>>ml</option>
                                <option value="L" <%if(recipe.getIngredientUnit().equals("L")){ %>selected<%}%>>L</option>
                            </select>
                        </td>
                    </tr>
                    <% } %>
