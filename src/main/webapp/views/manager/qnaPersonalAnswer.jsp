        ...
        <div class="section_right">
            ...
            <form action="" method="">
                <table class="table">
                    ...
                    <tr>
                        <th>제목</th>
                        <td><input type="text" readonly value="배송관련질문"  class="form-control"></td>
                    </tr>
                    <tr>
                        <th>내용</th>
                        <td>
                            <textarea name="" id="" cols="30" rows="10" readonly  class="form-control">평균 몇일정도 걸리나요</textarea>
                        </td>
                    </tr>
                    <tr>
                        <th>답변</th>
                        <td>
                            <textarea name="" id="" cols="30" rows="10" placeholder="내용을 입력해주세요"  class="form-control"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <div class="files" class="fomt-"><input type="file" class="form-control"></div>
                        </td>
                    </tr>
                </table> 
