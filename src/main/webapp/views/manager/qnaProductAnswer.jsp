        ...
        <div class="section_right">
            ...
            <form action="" method="">
                <table class="table">
                    <tr>
                        <th>번호</th>
                        <td><input type="text" readonly value="4" class="form-control"></td>
                    </tr>
                    <tr>
                        <th>제목</th>
                        <td><input type="text" readonly  class="form-control" value="상품입고문의용"></td>
                    </tr>
                    <tr>
                        <th>내용</th>
                        <td>
                            <textarea name="" id="" cols="30" rows="10" class="form-control" readonly>상품입고는 언제되나요? </textarea>
                        </td>
                    </tr>
                    <tr>
                        <th>답변</th>
