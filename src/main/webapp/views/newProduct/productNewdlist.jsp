            ...
            <script>
            	$(function(){
            		$("#option").change(function(){	
            			location.href = "<%=contextPath%>/sddlistNew.pr?page=1&select=" + $(this).val();			
            		})
            	})
            </script>
                   ...
                   <% if(search == null && select == null) { %>
	                   <div style="display: flex; justify-content: center; align-items: center;">
						  ...
						  <!-- 페이징바 영역 start -->
	                        ...
	                        <% } else { %>
	                            <li class="page-item"><a class="page-link" href="<%= contextPath %>/dlistNew.pr?page=<%= pi.getCurrentPage() - 1%>">Previous</a></li>
	                        <% } %>
	                        ...
	                        <% for(int p = pi.getStartPage(); p<=pi.getEndPage(); p++) {  %>
	                            ...
	                            <% } else { %>
	                            <li class="page-item"><a class="page-link" href="<%= contextPath %>/dlistNew.pr?page=<%= p %>"><%= p %></a></li>
	                            <% } %>
	                        <% } %>
	                        ...
	                        <% } else { %>
	                            <li class="page-item"><a class="page-link" href="<%= contextPath%>/dlistNew.pr?page=<%= pi.getCurrentPage() + 1 %>">Next</a></li>
	                        <% } %>
	                        </ul>
	                        <!-- 페이징바 영역 end -->
                    ...
                    <div style="display: flex; justify-content: center; align-items: center;">
						  ...
						  <!-- 페이징바 영역 start -->
	                        ...
	                        <% for(int p = pi.getStartPage(); p<=pi.getEndPage(); p++) {  %>
	                            ...
	                            <li class="page-item active"><a class="page-link" href="#"><%= p %></a></li>
	                            <% } else { %>
	                            <li class="page-item"><a class="page-link" href="<%= contextPath %>/sdlistNew.pr?page=<%= p %>&search=<%= search %>"><%= p %></a></li>
	                            <% } %>
	                        <% } %>
							...
							<% if(pi.getCurrentPage() == pi.getMaxPage()) { %>
	                         	<li class="page-item disalbed"><a class="page-link" href="#">Next</a></li>
	                        <% } else { %>
	                            <li class="page-item"><a class="page-link" href="<%= contextPath%>/sdlistNew.pr?page=<%= pi.getCurrentPage() + 1 %>&search=<%= search %>">Next</a></li>
	                        <% } %>
	                        </ul>
	                        <!-- 페이징바 영역 end -->
	                   </div>   
                   	 ...
                   	 <div style="display: flex; justify-content: center; align-items: center;">
						  ...
						  <!-- 페이징바 영역 start -->
	                        ...
	                        <% if(pi.getCurrentPage() == 1) { %>
	                            <li class="page-item disabled"><a class="page-link" href="#">Previous</a></li>
	                        <% } else { %>
	                            <li class="page-item"><a class="page-link" href="<%= contextPath %>/sddlistNew.pr?page=<%= pi.getCurrentPage() - 1%>&select=<%= select %>">Previous</a></li>
	                        <% } %>
	                        ...
	                        <% for(int p = pi.getStartPage(); p<=pi.getEndPage(); p++) {  %>
	                            ...
	                            <li class="page-item active"><a class="page-link" href="#"><%= p %></a></li>
	                            <% } else { %>
	                            <li class="page-item"><a class="page-link" href="<%= contextPath %>/sddlistNew.pr?page=<%= p %>&select=<%= select %>"><%= p %></a></li>
	                            <% } %>
	                        <% } %>
							...
							<% if(pi.getCurrentPage() == pi.getMaxPage()) { %>
	                         	<li class="page-item disalbed"><a class="page-link" href="#">Next</a></li>
	                        <% } else { %>
	                            <li class="page-item"><a class="page-link" href="<%= contextPath%>/sddlistNew.pr?page=<%= pi.getCurrentPage() + 1 %>&select=<%= select %>">Next</a></li>
	                        <% } %>
	                        </ul>
	                        <!-- 페이징바 영역 end -->
	                   </div>   
    ...
    <script>
        $(function(){
          ...
          $("#search_btn").click(function(){
        	  location.href = "<%=contextPath%>/sdlistNew.pr?search=" + $("#search").val() + "&page=1";
          })
