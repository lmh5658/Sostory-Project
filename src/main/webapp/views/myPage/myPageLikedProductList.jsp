...
<!-- =========================================================================================================================== -->
                ...
                <div class="main-page">
                    ...
                    <div style="margin-left: 20px; width:970px; border-bottom:1px solid lightgray;">
                        <h4 class="btn categoryBtn"><b class="category">상품</b></h4>
                        <h4 class="btn categoryBtn"><b class="category">레시피</b></h4>
                    </div>
                    <!-- 페이지 제목 영역 end -->
                    ...
                    <div class="product-thumbnail-list d-flex flex-column w-100">
                        ...
                        <div class="thumbnail-list-top d-flex w-100 justify-content-evenly"> 
                            ...
                            <div class="product img-thumbnail p-2" style="width:300px">
                                <img class="product-img" src="../../resources/images/이미지1.jpg" alt="Card image" style="width:100%">
