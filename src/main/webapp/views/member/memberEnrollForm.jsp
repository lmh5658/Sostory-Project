					...
					<form action="signup.me" method="">
						<table class="signup-table">
							...
							<tr>
								<th>* 휴대폰번호</th>
								<td colspan="2">
									<input type="text" class="form-control" placeholder="휴대폰번호를 입력하세요" required>
								</td>
								<td></td>
							</tr>
							...
							<tr>
								<th>* 이메일</th>
								<td colspan="2">
									<input type="email" class="form-control" placeholder="이메일 입력" required>
								</td>
							</tr>
						...
						<table class="terms">
							...
							<tr>
								<td class="terms"><input type="checkbox">&nbsp;이용 약관 동의(필수)</label></td>
								<!-- + 버튼 누르면 이용약관 팝업 창 뜨도록-->
								<td><button type="button" class="btn btn-secondary mx-3 center terms-btn">+</button>
								</td>
							</tr>
							<tr>
								<td class="terms"><input type="checkbox">&nbsp;개인정보 수집 및 이용 동의(필수)</td>
								<!-- + 버튼 누르면 이용약관 팝업 창 뜨도록-->
								<td><button type="button" class="btn btn-secondary mx-3 center terms-btn">+</button>
								</td>
							</tr>
							<tr>
								<td class="terms"><input type="checkbox">&nbsp;만 14세 이상(필수)</td>
							</tr>
